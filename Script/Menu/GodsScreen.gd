...
####################################################################################################
func _on_god_of_the_sect_button_down():
	GlobalValueMenu.godSelect = "GodOfTheSect"
	emit_signal("godSelected", "GodOfTheSect")
	get_node("DisplaySpriteGod").texture = null
	get_node("HoverSelectionGods").texture = null
	self.hide()
	get_node("/root/Menu/Background/PowerGods").show()

func _on_god_of_the_sect_mouse_entered():
	get_node("DisplaySpriteGod").texture = load("res://Image/Gods/GodOfTheSect/Dieu de la Secte IA - Couleur.png")
	get_node("HoverSelectionGods").texture = load("res://Image/Menu/HoverSelectionGods.png")
	get_node("HoverSelectionGods").position.x = 524
	get_node("HoverSelectionGods").position.y = 130

func _on_god_of_the_sect_mouse_exited():
	get_node("DisplaySpriteGod").texture = null
	get_node("HoverSelectionGods").texture = null
