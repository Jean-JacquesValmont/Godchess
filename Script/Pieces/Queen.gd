...
func createNewPieceMovePreview(dx,dy,f,color):
	...
	if color == "White":
		previewSprite.texture = load("res://Image/Gods/" + GlobalValueMenu.godSelectPlayer1 + "/Pieces/Base pièce doubler - Reine.png")
	elif color == "Black":
		previewSprite.texture = load("res://Image/Gods/" + GlobalValueMenu.godSelectPlayer2 + "/Pieces/Base pièce doubler - Reine.png")
...
func _on_animation_power_of_god_animation_finished():
	...
	if get_node("AnimationPowerOfGod").get_animation() == "PowerGoddessOfTeleportationEffectInitialQueen":
		...
		if OnlineMatch._nakama_multiplayer_bridge.multiplayer_peer._self_id == 1:
			...
			GlobalValueChessGame.chessBoard = GlobalValueChessGame.reverseChessBoard(chessBoard)
		Position = Vector2(self.position.x, self.position.y)
		get_node("AnimationPowerOfGod").set_animation("PowerGoddessOfTeleportationEffectFinalQueen")
		get_node("AnimationPowerOfGod").play()
	elif get_node("AnimationPowerOfGod").get_animation() == "PowerGoddessOfTeleportationEffectFinalQueen":
...
func _on_animation_power_of_god_frame_changed():
	...
	if get_node("AnimationPowerOfGod").get_animation() == "PowerGodOfTheSectConversion":
		if get_node("AnimationPowerOfGod").get_frame() == 1:
			...
			lastChild.texture = load("res://Image/Gods/GodOfTheSect/Pieces/Base pièce doubler - Reine.png")
			lastChild.i = i
			lastChild.j = j
